...
export const envs = {
  port: envVars.PORT,
  productMicroHost: envVars.PRODUCT_MICROSERVICE_HOST,
  productMicroPort: envVars.PRODUCT_MICROSERVICE_PORT,
  orderMicroHost: envVars.ORDER_MICROSERVICE_HOST,
  orderMicroPort: envVars.ORDER_MICROSERVICE_PORT
}